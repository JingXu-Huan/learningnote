...
- [[数据库事务]] —— @Transactional 本质就是 AOP
- [[技术栈/Java与框架/Java/java的反射]] —— AOP 底层大量使用反射（获取注解、方法、代理）
- [[项目与成长/面经/美团校招Java后端一面]] —— 面试中 AOP 相关考点
- [[项目与成长/开发经验/第一个大项目-01进销存/全局异常处理器]] —— @RestControllerAdvice 就是 AOP 思想的体现
- [[技术栈/Java与框架/多线程/线程池七大核心参数]] —— 线程池 + AOP 实现统一日志与性能监控
