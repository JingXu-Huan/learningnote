...
- [[技术栈/数据库/Redis/Redisson/redisson_lock_guide]] —— 生产级 Redisson 分布式锁（可重入、看门狗续期）
- [[技术栈/数据库/Redis/数据结构]] —— String 类型的 SETNX 命令是分布式锁的基石
- [[关于使用缓存]] —— Redis 缓存模式与实战经验
- [[项目与成长/面经/如何解决缓存和数据库的数据不一致性]] —— 缓存与数据库一致性方案
- [[技术栈/Java与框架/多线程/线程池七大核心参数]] —— 多线程并发是分布式锁要解决的核心问题  
